...
if (description){
	...
	draw_set_halign(fa_center);
	draw_text_color(x+23,y+62,"Get a temporal shield while you keep your combo",brick_blue,brick_blue,brick_blue,brick_blue,1);
	draw_text(x+24,y+61,"Get a temporal shield while you keep your combo");
}