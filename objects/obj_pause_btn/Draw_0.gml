...
if(global.paused)
{
	...
	if(surface_exists(surface_pausa)){
		draw_surface(surface_pausa,global.camera_offset,0);
	}
	else
	{
	...
	draw_text_color((camera_get_view_width(view_camera[0])/2)+2+global.camera_offset,(camera_get_view_height(view_camera[0])*(2/5))+2,"PAUSED",brick_blue,brick_blue,brick_blue,brick_blue,1);
	draw_text((camera_get_view_width(view_camera[0])/2)+global.camera_offset,camera_get_view_height(view_camera[0])*(2/5),"PAUSED");
}
